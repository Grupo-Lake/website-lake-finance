    ...
    roles: [
      {
        ...
        type: "Full-time",
        desc: "Você vai construir os sistemas que processam dados financeiros de milhares de usuários. Stack: Next.js, Node.js, PostgreSQL, AWS.",
        cta: "Candidatar-se",
      },
      {
        ...
        location: "Remoto · Brasil",
        type: "Full-time",
        desc: "Design de produto do zero ao lançamento. Você define como a IA financeira precisa parecer e se comportar para ser realmente útil.",
        cta: "Candidatar-se",
      },
      {
        ...
        location: "Remoto · Brasil",
        type: "Full-time",
        desc: "Modelos de categorização, previsão de saldo e Health Score. Você vai treinar e evoluir a IA que está no coração do Lake.",
        cta: "Candidatar-se",
      },
    ],
    noRole: "Não viu sua área?",
    noRoleDesc: "Mande um e-mail com seu perfil para",
    email: "talentos@lakefi.com.br",
  },
  en: {
    eyebrow: "CAREERS",
    ...
    roles: [
      {
        ...
        type: "Full-time",
        desc: "You'll build the systems that process financial data for thousands of users. Stack: Next.js, Node.js, PostgreSQL, AWS.",
        cta: "Apply",
      },
      {
        title: "Product Designer",
        ...
        location: "Remote · Brazil",
        type: "Full-time",
        desc: "Product design from zero to launch. You define how financial AI needs to look and behave to be truly useful.",
        cta: "Apply",
      },
      {
        title: "Data Scientist — Finance ML",
        ...
        location: "Remote · Brazil",
        type: "Full-time",
        desc: "Categorization models, balance forecasting, and Health Score. You'll train and evolve the AI at the heart of Lake.",
        cta: "Apply",
      },
    ],
    noRole: "Don't see your area?",
